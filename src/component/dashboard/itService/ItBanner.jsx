  ...
  const fetchData = async (id) => {
    try {
      ...
      if (result.status) {
        ...
        setEditData({
          h1: result.banner.bannerSection.h1,
          description: result.banner.bannerSection.description,
          image: result.banner.bannerSection.image,
                ...
                <div>
                  ...
                  <div>
                    {isSaving ? (
                      ...
                      <button onClick={()=>handleSaveClick(editData._id)} className="mx-4">
                          Save
                        </button>
                      </div>
                    )}
