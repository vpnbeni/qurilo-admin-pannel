        ...
        {(showAll ? services : services.slice(0, 3)).map((service) => (
          ...
          >
            ...
            <div className="absolute top-4 right-4 opacity-0 group-hover:opacity-100 transition-opacity duration-300">
              <button onClick={() => handleDeleteCard(service._id)} className="text-red-500">
                <RxCross2 size={32} />
              </button>
            </div>
...
//               />
//             ) : (
//               <p className="text-base flex-grow font-normal break-words ">
...
//             <div className="flex justify-end opacity-0 group-hover:opacity-100 transition-opacity duration-300">
//               {editingId === service._id ? (
//                 <button onClick={() => handleEditData(service._id)} className='bg-green-600 text-white rounded-md px-2 py-2'>Save</button>
//               ) : (
//                 <button onClick={() => handleEditClick(service._id)} className="mt-2">
//                   <MdEdit size={32} />
//                 </button>
...
//           </div>
//         ))}
//         <div className=" absolute right-0 top-20  text-center pb-4 ">
//         <button
//           onClick={handleAddCardClick}
//           className="bg-blue-400 font-bold group-hover:block hidden bg-white   text-black py-1 px-4 text-lg rounded-lg"
//         >
...
//                 className="text-white bg-red-500 py-2 px-4 rounded-md mr-2"
//               >
//                 Cancel
//               </button>
//               <button
//                 onClick={handleSaveNewCard}
//                 className="bg-blue-500 text-white bg-green-500 py-2 px-4 rounded-md"
//               >
//                 Save
//               </button>
//             </div>
...
//             <div className="flex justify-end">
//               <button
//                 onClick={() => setIsEditingMainHeading(false)}
//                 className="text-white bg-red-500 py-2 px-4 rounded-md mr-2"
//               >
//                 Cancel
//               </button>
