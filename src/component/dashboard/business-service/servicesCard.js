...
//             // Optionally update state with the new data from the response
//         } catch (error) {
//             console.error('Error updating data:', error);
//         }
//         setEditingId(null);
...
//             setServices((prev) => ({
//                 ...prev,
//                 cardServiceData: prev.cardServiceData.filter((service) => service?._id !== cardId),
//             }));
//         } catch (error) {
//             console.error('Error deleting data:', error);
//         }
...
//             </div>
//             <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-5 lg:gap-10 mb-20 my-20">
//                 {services?.cardServiceData?.map((service) => (
//                     <div key={service?._id} className="group relative flex flex-col  py-10 rounded-xl border-2  hover:border-[#558BDC] hover:border-2  p-4 cursor-pointer min-h-full">
//                         {
//                             editingId === service?._id ? (
//                                 <div>
...
//             </div>
//             <div className='text-center pb-4'>
//                 <button className='bg-blue text-white py-1 px-4 text-lg rounded-lg'>
//                     Load More
//                 </button>
//             </div>
//             <div className="absolute   bottom-4 right-4 ">
